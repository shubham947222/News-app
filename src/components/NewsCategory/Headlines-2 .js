...
const Headlines2 = ({ news, setNews, Title }) => {
  console.log(Title);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://api.mediastack.com/v1/news?access_key=${API_KEY}&sources=cnn,bbc,ndtv&sort=published_desc`
      )
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "space-evenly" }}>
        ...
        >
          Keep <span style={{ fontWeight: "bold" }}>{Title}</span> on NewsFeeder
        </h1>
        <div
          style={{
            position: "relative",
